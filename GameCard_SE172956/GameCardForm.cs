...
namespace GameCard_SE172956
{
    public partial class GamecardForm : Form
    {
        ...
        private GameCardInfoService gamecardService = new();
        ...
        private void GamecardForm_Load(object sender, EventArgs e)
        {
            ...
            if (this.GameCardId != null)
            {
                ...
                var gameCardInfo = gamecardService.GetAGameCardInfo((int)GameCardId);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            string gameCardName = txtName.Text.Trim();
            if (gameCardName.Length < 2 || gameCardName.Length > 60)
            {
                MessageBox.Show("GamecardName must have a length between 2 and 60 characters.",
                    "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            string[] words = gameCardName.Split(' ');
            ...
            if (GameCardId != null)
                gamecardService.UpdateAGameCardInfo(gameCardInfo);
            else
                gamecardService.AddAGameCardInfo(gameCardInfo);
